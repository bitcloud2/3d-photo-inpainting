# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00_mesh_tools.ipynb (unless otherwise specified).

__all__ = ['relabel_node', 'filter_edge', 'extrapolate', 'get_valid_size', 'dilate_valid_size', 'size_operation',
           'fill_dummy_bord', 'enlarge_border', 'fill_missing_node', 'refresh_bord_depth', 'get_union_size',
           'incomplete_node', 'edge_inpainting', 'depth_inpainting', 'update_info', 'build_connection',
           'recursive_add_edge', 'resize_for_edge', 'get_map_from_nodes', 'get_map_from_ccs', 'revise_map_by_nodes',
           'repaint_info', 'get_context_from_nodes', 'get_mask_from_nodes', 'get_edge_from_nodes',
